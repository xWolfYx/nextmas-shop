...
export default function Hero() {
  return (
    <section className="flex h-[524px] gap-3 flex-col items-center justify-center rounded-t-[20px] bg-[#ff4646] bg-[url(/backgrounds/bg-snow.png),url(/backgrounds/bg-ball.png)] bg-cover bg-center *:text-white">
